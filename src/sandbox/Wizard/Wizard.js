...
import { HeaderSection, Button } from 'src/pureComponents/index';
import { userActions } from 'src/data/user/index';
...
export class Wizard extends Component {
  ...
  renderWizard = () => {
    ...
    if (pageIndex === 0)
      ...
      return (
        <View style={{ flex: 1 }}>
          <SecondStep userProfile={userProfile} />
        </View>
      );
  };
  ...
  renderFirstButton = () => {
    return (
      <View style={{ marginVertical: 20 }}>
        <Button onPress={this.saveUser.bind(this, 1)}>Next</Button>
      </View>
    );
  };
  ...
  renderSecondButton = () => {
    return (
      <View style={{ marginVertical: 20 }}>
        <Button onPress={this.saveUser.bind(this)}>Save</Button>
      </View>
    );
  };
